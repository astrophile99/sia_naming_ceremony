...
function PhotoCard({
  ...
  // Deterministic tall pattern: ~1 in 5 photos spans 2 rows for visual rhythm
    ...
    >
      ...
      <div className="absolute inset-0">
        <Image
          ...
          alt={photo.alt}
          fill
          sizes="(max-width: 640px) 34vw, (max-width: 1024px) 26vw, 21vw"
      ...
      <div className="max-w-7xl mx-auto">
        {filteredPhotos.length === 0 ? (
          ...
          >
            ...
            <p className="font-display italic text-rose-400 text-xl mb-2">No photos yet</p>
            <p className="font-body text-sm text-rose-400/60 max-w-sm">
              Add images to{" "}
              <code className="bg-rose-50 px-1.5 py-0.5 rounded text-rose-500 text-xs">
                public/photos/ceremony/
              </code>{" "}
              (or family / candid / details), then run{" "}
              <code className="bg-rose-50 px-1.5 py-0.5 rounded text-rose-500 text-xs">npm run scan</code>
            </p>
          </motion.div>
        ) : (
          <motion.div
